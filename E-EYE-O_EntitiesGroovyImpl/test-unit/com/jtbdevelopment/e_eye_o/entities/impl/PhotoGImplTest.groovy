 ...
 * Time: 12:32 PM
 */
class PhotoGImplTest extends AppUserOwnedObjectGImplTest {
    @BeforeMethod
    def setUp() {
        objectUnderTest = new PhotoGImpl()
    }

    @Test
    public void testPhotoFor() {
        testNonStringFieldWithNullValidationError("photoFor", null, new ObservationGImpl(), Photo.PHOTO_PHOTO_FOR_CANNOT_BE_NULL_ERROR)
    }

    @Test
    public void testTimestamp() {
        LocalDateTime before = new LocalDateTime();
        PhotoGImpl photo = new PhotoGImpl();
