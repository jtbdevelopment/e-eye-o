 ...
 * Time: 7:01 AM
 */
abstract class AbstractIdObjectFactoryTest {
    public static
    final List<Class<?>> NOT_APP_USER_CLASSES_ARRAY = [Object.class, List.class, String.class, Integer.class, Set.class, HashMap.class];
    //  TODO - dynamic
    public static
    final List<Class<? extends AppUserOwnedObject>> APP_USER_OWNED_CLASSES_ARRAY = [ClassList.class, Student.class, DeletedObject.class, Photo.class, Observation.class, ObservationCategory.class, TwoPhaseActivity.class, AppUserSettings.class, Semester.class];
    private static final MockFor context = new MockFor(AppUser.class);
    private static final AppUser appUser = (AppUser) context.proxyInstance();
    IdObjectFactory factory

    abstract IdObjectFactory createFactory();

    abstract String getExpectedBuilderClassName(String name);

    abstract String getExpectedImplClassName(String name);
