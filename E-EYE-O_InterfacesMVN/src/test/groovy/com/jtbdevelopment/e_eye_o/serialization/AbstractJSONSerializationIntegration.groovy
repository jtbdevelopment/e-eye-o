 ...
 * Time: 3:47 PM
 */
abstract class AbstractJSONSerializationIntegration extends AbstractTestNGSpringContextTests {
    @Autowired
    protected JSONIdObjectSerializer serializer;

    @Autowired
    protected JSONIdObjectDeserializer deserializer
    ...
    protected void compareObjects(IdObject expected, IdObject compareTo) {
