...
public class ConfirmDeleteAccount extends PasswordConfirmingWindow {
    ...
    public ConfirmDeleteAccount(final AppUser appUser, final IdObjectDeletionHelper idObjectDeletionHelper, final AuthenticationManager authenticationManager, final DeletedAccountEmailGenerator deletedAccountEmailGenerator) {
