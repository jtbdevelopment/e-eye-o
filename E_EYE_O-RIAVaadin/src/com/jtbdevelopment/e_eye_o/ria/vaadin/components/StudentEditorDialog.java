 ...
 * Time: 6:36 PM
 */
public class StudentEditorDialog extends Window {
    public StudentEditorDialog(final ReadWriteDAO readWriteDAO, final EventBus eventBus, final Student student) {
        setSizeUndefined();
        setModal(true);
        addStyleName(Runo.WINDOW_DIALOG);
        setWidth(80, Unit.EM);
        setHeight(15, Unit.EM);
        setContent(new StudentForm(readWriteDAO, eventBus, student));
    }

    public static class StudentForm extends CustomComponent {
