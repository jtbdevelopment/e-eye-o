...
import com.jtbdevelopment.e_eye_o.ria.vaadin.utils.LocalDateConverter;
import com.jtbdevelopment.e_eye_o.ria.vaadin.utils.LocalDateTimeConverter;
...
public abstract class ObservationTable extends IdObjectTable<Observation> {
    ...
    static {
        headers = Arrays.asList(
                new HeaderInfo("observationTimestamp", "Observation Time", Table.Align.LEFT),
    ...
    protected void addColumnConverters() {
        ...
        entityTable.setConverter("followUpReminder", new LocalDateConverter());
        entityTable.setConverter("observationTimestamp", new LocalDateTimeConverter());
        ...
        entityTable.addGeneratedColumn("showFollowUp", new Table.ColumnGenerator() {
            ...
            public Object generateCell(final Table source, final Object itemId, final Object columnId) {
                ...
                if (entity.getFollowUpObservation() != null) {
                    ...
                    return showFollowUpButton;
                } else {
                    Button addFollowUp = new Button("Add Follow Up");
                    addFollowUp.addClickListener(new Button.ClickListener() {
                        @Override
                        public void buttonClick(final Button.ClickEvent event) {
                            showEntityEditor(idObjectFactory.newObservation(appUser));
                            //  TODO - link created observation to this observation and set follow up to false.
                        }
                    });
                    return addFollowUp;
                }
