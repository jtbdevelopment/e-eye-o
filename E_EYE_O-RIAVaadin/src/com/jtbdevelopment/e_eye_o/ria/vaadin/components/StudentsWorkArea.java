...
public class StudentsWorkArea extends CustomComponent {
    ...
    private void buildMainLayout() {
        ...
        BeanItemContainer<Student> students = new BeanItemContainer<>(Student.class, readWriteDAO.getEntitiesForUser(Student.class, appUser));
        ...
        table.addItemClickListener(new ItemClickEvent.ItemClickListener() {
            ...
            public void itemClick(final ItemClickEvent event) {
                ...
                if (item instanceof BeanItem) {
                    studentForm.setStudent(((BeanItem<Student>) item).getBean());
                } else {
