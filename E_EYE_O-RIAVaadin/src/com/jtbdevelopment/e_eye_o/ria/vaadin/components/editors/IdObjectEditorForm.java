...
public abstract class IdObjectEditorForm<T extends AppUserOwnedObject> extends CustomComponent {
    ...
    public IdObjectEditorForm(final Class<T> entityType, final ReadWriteDAO readWriteDAO, final EventBus eventBus) {
    ...
    protected void buildMainLayout() {
        ...
        for (Field field : entityBeanFieldGroup.getFields()) {
            field.addValidator(new BeanValidator(entityType, (String) entityBeanFieldGroup.getPropertyId(field)));
