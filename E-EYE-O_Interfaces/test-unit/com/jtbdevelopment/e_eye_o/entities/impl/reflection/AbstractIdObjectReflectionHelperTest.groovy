...
abstract class AbstractIdObjectReflectionHelperTest {
    ...
    private static final Set<String> FIELDS_WITH_SETTINGS = (["intValue", "appUserOwnedObject", "modificationTimestamp", "id"] as Set)
    ...
    public void testFieldPreferencesOnInterface() {
        ...
        methods = methods.findAll { it.getAnnotation(IdObjectFieldSettings) != null }.collect({ it.getAnnotation(IdObjectFieldSettings.class) }) as Set;
