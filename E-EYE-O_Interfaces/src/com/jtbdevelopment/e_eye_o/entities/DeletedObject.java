 ...
 */
@IdObjectPreferredDescription(singular = "Deleted Item", plural = "Deleted Items")
@IdObjectDisplayPreferences(viewable = false, defaultSortField = "deletedId", editable = false)
